...
function loadPlaces(map, lat, lng) {
  _axios2.default.get('/api/stores/near?=' + lat + '&lng=' + lng).then(function (res) {
    var places = res.data;
    if (!place.length) {
    ...
    //when someone clicks on a marker show the info window
    ...
    // zoom in on the markers perfecto
...
function typeAhead(search) {
  ...
  searchInput.on('keyup', function (e) {
    // if they don't press down, up or enter, who cares
